    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          null,
          _index2.default.map(function (_ref) {
            var path = _ref.path,
                exact = _ref.exact,
...
var routes = [{
  ...
  fetchInitialData: function fetchInitialData() {
    ...
    return (0, _user.fetchPopularRepos)(path.split("/").pop());
  }
}];
  ...
  _createClass(Grid, [{
    ...
    value: function componentDidMount() {
      if (!this.state.repos) {
        ...
        fetch("https://m.mamba.ru/api/ratings/v2/voting/photos?ageFrom=18&ageTo=25&gender=F&limit=30&location=3159_4312_4400_0");
      }
    }
  }, {
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.fetchRepos = function (lang) {
    ...
    _this2.props.fetchInitialData(lang).then(function (repos) {
...
function fetchPopularRepos() {
  ...
  var encodedURI = encodeURI("https://api.github.com/search/repositories?q=stars:>70000+language:" + language + "&sort=stars&order=desc&type=Repositories&limit=20");
